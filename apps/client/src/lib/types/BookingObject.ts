...
interface TutenUserProfessional4 {
...
interface TutenUserProfessional3 {
  weekAvailability: string
  hourAvailability: string
  serviceData: string
  referrers: string
...
interface TutenUserProfessional2 {
  weekAvailability: string
  hourAvailability: string
  serviceData: string
  referrers: string
...
interface TutenUserProfessional {
  weekAvailability: string
  hourAvailability: string
  serviceData: string
  referrers: string
...
interface TutenUserProfessionalRole {
  userRole: string
  description: string
